...
public partial class MessageSerializer
{
    ...
    static public AnimationCurve Read_AnimationCurve(BinaryReader reader)
    {
        ...
        if (keyCount > 0)
        {
            ...
            for (int i = 0; i < keyCount; ++i)
            {
                ...
                keyFrame.tangentMode = reader.ReadInt32();
                keyFrame.inTangent = reader.ReadSingle();
                keyFrame.outTangent = reader.ReadSingle();
    ...
    static public string[] ReadArray_string(BinaryReader reader)
    {
        Int16 count = reader.ReadInt16();
        if (count <= 0)
        {
    ...
    static public void Write_AnimationCurve(BinaryWriter writer, ref AnimationCurve value)
    {
        if (value != null)
        {
            var keyCount = value.length;
            writer.Write(keyCount);
            for (int i = 0; i < keyCount; ++i)
            {
                var keyFrame = value.keys[i];
                writer.Write(keyFrame.time);
                writer.Write(keyFrame.value);
                writer.Write(keyFrame.tangentMode);
    ...
    static public void WriteArray_string(BinaryWriter writer, string[] value)
    {
        ...
        Write_Int16(writer, (short)value.Length);
