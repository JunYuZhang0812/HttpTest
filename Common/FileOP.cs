...
public class FileOP
{
    ...
    public static FileOP Instance
    {
        get
        {
            if (_instance == null)
            {
                ...
                _instance.CreateFile(APP_PATH + "\\配置文件.txt");
            }
            return _instance;
        }
    }
    private static string _APP_PATH = null;
    public static string APP_PATH
    {
        get
        {
            if (_APP_PATH == null)
            {
                _APP_PATH = Application.StartupPath;
            }
            return _APP_PATH;
        }
    }
    ...
    {
        WritePrivateProfileString(strSection, strKey, null, m_filePath);
    }
}
